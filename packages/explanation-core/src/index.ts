...
export function buildExplanationPrompt(request: ExplainRequest): ExplanationPrompt {
  ...
  return {
    instructions: [
      ...
      'Synonyms must be true substitutes, aliases, abbreviations, or alternate names. Do not include merely related concepts, and provide none when they do not apply.',
